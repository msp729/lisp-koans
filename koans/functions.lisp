...
(define-test optional-parameters
    ...
    (assert-equal '(42 24 ()) (function-with-optional-parameters 42 24))
    (assert-equal '(42 3 ()) (function-with-optional-parameters 42))
    (assert-equal '(2 3 ()) (function-with-optional-parameters)))
...
(define-test keyword-parameters ()
    (assert-equal '(:something () ()) (function-with-keyword-parameters))
...
(define-test funky-parameters
    (assert-equal '(1 () 1 nil ()) (function-with-funky-parameters 1))
    (assert-equal '(1 2 1 () (:b 2)) (function-with-funky-parameters 1 :b 2))
