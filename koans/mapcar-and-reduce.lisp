...
(define-test mapcar
    (let ((numbers '(1 2 3 4 5 6)))
        ...
        (assert-equal (list -1 -2 -3 -4 -5 -6) (mapcar #'- numbers))
        (assert-equal '((1) (2) (3) (4) (5) (6)) (mapcar #'list numbers))
        (assert-equal '(() t () t () t) (mapcar #'evenp numbers))
        (assert-equal '(t t t t t t) (mapcar #'numberp numbers))
        (assert-equal '(() () () () () ()) (mapcar #'stringp numbers))
...
(define-test mapcar-lambda
    ...
    (let ((numbers '(8 21 152 37 403 14 7 -34)))
        (assert-equal (list 8 1 2 7 3 4 7 6) (mapcar (lambda (x) (mod x 10)) numbers)))
